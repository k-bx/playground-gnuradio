...
class SSB_rcv(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._tuning_range = Range(11000, 21000, 100, 17500, 200)
        ...
        self._volume_range = Range(0, 1, .05, .5, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(audio_rate, analog.GR_COS_WAVE, 1500, 1, 0, 0)
