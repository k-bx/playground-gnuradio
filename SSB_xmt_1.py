...
class SSB_xmt_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SSB_xmt_1")
        ...
        self.interp = interp = samp_rate / audio_rate
        self.carrier_freq = carrier_freq = 16000

        ##################################################
        # Blocks
        ##################################################
        self._volume_range = Range(0, 20, .100, 10, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_interp(self.samp_rate / self.audio_rate)
...
def main(top_block_cls=SSB_xmt_1, options=None):
